import { Calendar, CheckCircle2, CircleAlert, Download, Plus, Search, Settings, Trash } from 'lucide-react';
...
export default function AdminStudents() {
    ...
    const fetchStudentsData = async () => {
        ...
        if(data) {
            ...
            await Promise.all(data.map(async(sD) => {
    ...
    const fetchScheduledDate = async (stdID) => {
        ...
        try {
            ...
            if (error) {
                ...
                console.log(`Lessons for ${stdID}:`, data);
                console.log(data);
                console.log(data[0].scheduled_date);
    ...
    const handleAddStudent = async () => {
        ...
        console.log('Student Form:', studentsForm);
        console.log('Student Modules:', studentsModule);
    
        // Check if all fields are filled
        if (!Object.values(studentsForm).every(value => Boolean(value))) {
        ...
        if (studentsForm.full_name.length < 5) {
            console.log('Full name cannot be less than 5 characters');
            setLoading(false);
            setAlert((prev) => ({
                ...prev,
                fullName: true
        ...
        if (studentsForm.phone_number.length !== 10) {
        ...
        console.log('Form is valid! Start updating db');
        ...
        if (data) {
            ...
            console.log('Student\'s data:', data[0].id);
            await updateStudentModuleAssi(data[0].id);
        } else {
            console.log('Error updating students table:', error?.message);
            setAlert((prev) => ({
                ...prev,
                alreadyExists: true
            }));
    ...
    const handleDeleteStudent = async (stdID) => {
        ...
        try {
            ...
            console.log('Unexpected error occured while deleting student:', error);
        }

    }
    
    const updateStudentModuleAssi = async (studentID) => {
        ...
        const { data:stdModulesData, error:stdModulesError } = await supabase
        ...
        console.log('Error inserting data to student_module_assi table:', stdModulesError?.message);
        console.log(studentsModule);
                                            ...
                                            <fieldset className="w-full fieldset">
                                                ...
                                                >
                                                    ...
                                                    {unexpectedErr.unexpectedError2 ? (
                                                        <>
                                                            <p className='text-red-500 font-medium'>Unexpected error occured while fetching modules data</p>
                                                        </>
                                                    ) : (
                                                        ''
                                                    )}
                                ...
                                <table className="table">
                                    ...
                                    <tbody>
                                        ...
                                        {alert.unexpectedError ? (
                                            <>
                                                <p className='flex items-center text-red-500 text-md font-medium'><CircleAlert size={17} className='mr-2'/> Error fetching student data</p>
                                            </>
                                        ): (
                                            ''
                                        )}
