...
export default function AccordionTm() {
    const accordionItems = [
        {
            title: "தொகுதி 1",
            badge: "முடிக்கப்பட்டது",
            desc: "வாகனத்தை பாதுகாப்பாக இயக்குவதற்கான அடிப்படைகளைக் கற்றுக்கொள்ளுங்கள்.",
            content: [
                { task: 'பணி 1', done: true },
                { task: 'பணி 2', done: true},
                { task: 'Tபணிask 3', done: true},
            ],
            completed: 100
        },
        {
            ...
            content: [
                { task: 'பணி 1', done: true },
                { task: 'பணி 2', done: true },
                { task: 'பணி 3', done: true },
            ],
            completed: 100
        },
        {
            title: "தொகுதி 3",
            badge: "நிலுவையில் உள்ளது",
            desc: "வாகனத்தை பாதுகாப்பாக இயக்குவதற்கான அடிப்படைகளைக் கற்றுக்கொள்ளுங்கள்.",
            content: [
                { task: 'பணி 1', done: false },
                { task: 'பணி 2', done: false },
                { task: 'பணி 3', done: false },
            ],
            completed: 0
        },
    ];
                            ...
                            <div className="prog">
                                <div className="prog-details flex items-center justify-between w-[440px] mt-4">
                                    <span className="flex items-center gap-3" >
                                        ...
                                        <p>{item.completed < 100 ? "திட்டமிடப்பட்ட தேதி" : "முடிக்கப்பட்ட தேதி"} March 27, 2024</p>
                                    </span>
